            ...
            <DropdownMenuContent className="p-1 flex flex-col gap-y-1">
              {lists.map(({label, icon:Icon,isActive,onClick})=>(
                <button
                    key={label}
                    onClick={onClick}
                    className={cn("flex items-center gap-x-2 px-2 py-2 rounde-sm hover:bg-neutral-200/80", 
            ...
            <DropdownMenuContent className="p-1 flex flex-col gap-y-1">
              {alignments.map(({label, value, icon:Icon})=>(
                <button
                    ...
                    className={cn("flex items-center gap-x-2 px-2 py-2 rounde-sm hover:bg-neutral-200/80", 
                       editor?.isActive("textStyle", { textAlign: value }) && "bg-neutral-200/80")}
                    >
                    <Icon className="size-4"/>
                    <span className="text-sm">{label}</span>
                </button>
        ...
        <DropdownMenu>
            <DropdownMenuTrigger asChild>
                ...
                >
                    ...
                    <div className="h-0.5 w-full " style={{background:value}}></div>
                </button>
            </DropdownMenuTrigger>
            <DropdownMenuContent className="p-2.5">
                <SketchPicker
            ...
            <DropdownMenuContent className="p-1 flex flex-col gap-y-1">
              {headings.map(({label, value, fontSize})=>(
                <button
                    ...
                    className={cn("flex items-center gap-x-2 rounde-sm hover:bg-neutral-200/80", 
        ...
        <DropdownMenu>
            ...
            <DropdownMenuContent className="p-1 flex flex-col gap-y-1">
               {fonts.map(({label, value})=>(
                    ...
                    key={value}  className={cn("flex items-center gap-x-2 rounde-sm hover:bg-neutral-200/80", 
...
export const Toolbar = () => {
    ...
    const sections :{label:string; icon:LucideIcon; onClick?:()=> void; isActive?: boolean;}[][] = [
        ...
        [
            ...
            },
            {
                ...
                isActive: editor?.isActive("bold") || editor?.isActive("italic") || editor?.isActive("underline"),
  ...
  return (
    ...
    <Separator orientation="vertical" className="h-6 bg-natural-300"/>
    <FontFamilyButton/>
    <Separator orientation="vertical" className="h-6 bg-natural-300"/>
    <HeadingLevelButton/>
    <Separator orientation="vertical" className="h-6 bg-natural-300"/>
